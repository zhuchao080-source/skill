...
Screen 02 should usually be a 5-6 selling-point grid overview. Each grid item has one selling point, short title, 15-20 character explanation, icon/product detail/scene thumbnail, unified spacing, shadow, and typography.
